...
public class JsonToFile {
    // 定义导出的路径信息
    final String txtPath="C:\\Users\\86152\\Desktop\\greenhouse\\greenhouse_list.txt";
    final String excelPath="C:\\Users\\86152\\Desktop\\greenhouse\\greenhouse_list.xls";
    ...
    public JSONObject setJsonTOTxt(JSONObject jsonObject) throws JSONException, IOException {
        ...
        json.put("txtDownloadPath","/greenhouse/greenhouse_list.txt");
        return json;
    }
    ...
    public void setJsonToExcel(JSONObject json,JSONObject jsonObject) throws IOException, JSONException {
        ...
        outputStream.flush();
        outputStream.close();
        jsonObject.put("excelDownloadPath","/greenhouse/greenhouse_list.xls");
